...
export function AddMapPage() {
    return (
        ...
        <div className="container-xxl bd-gutter pt-md-1 pb-md-4 text-bg-dark">
            ...
            Чтобы добавить интересующую вас онлайн карту, включите в браузере режим разработчика. Перейдите во вкладку Network и надите там любой тайл. Кликните правой кнопкой мыши и нажмите Copy - Copy as CURL. Вставьте результат в это поле.
